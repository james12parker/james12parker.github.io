      ...
      <div className="grid min-h-[42rem] lg:grid-cols-[0.82fr_1.18fr]">
        <div className="flex items-center">
          <div className="w-full px-5 py-18 md:px-8 lg:ml-auto lg:max-w-[44rem] lg:px-14">
            <p className="eyebrow mb-6">Bathroom details, considered</p>
            <h1 className="max-w-2xl text-[2.65rem] leading-[1.13] font-medium tracking-[-0.055em] text-balance sm:text-5xl lg:text-6xl">
              욕실을 완성하는
              <br />
              정제된 디테일
            </h1>
