...
| `/collections/shako`                         | Public collection page        | Included                 | Production indexable                           |
...
| `/products/shako-towel-bar`                  | Public product page           | Included                 | Production indexable                           |
| `/products/shako-toilet-paper-holder`        | Public product page           | Included                 | Production indexable                           |
